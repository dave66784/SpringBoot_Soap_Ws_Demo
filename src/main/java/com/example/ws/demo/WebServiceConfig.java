...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    @Bean(name = "serviceBrokerWsdl")
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema empSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setPortTypeName("getDataPort");
        wsdl11Definition.setLocationUri("/service");
        wsdl11Definition.setTargetNamespace("http://example.com/ws/jaxb/generated");
    ...
    public XsdSchema empSchema() {
        return new SimpleXsdSchema(new ClassPathResource("ServiceBroker.xsd"));
    }
    @Override
    public void addInterceptors(List<EndpointInterceptor> interceptors) {
    	interceptors.add(new ResponseHeaderInterceptor());
